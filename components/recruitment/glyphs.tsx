...
/* Icônes des tags de contact — Discord en glyphe de marque (fill), le reste en
   trait (stroke) pour rester cohérent avec l'iconographie « cyber minimal ».
   Partagées par la carte d'annonce et la modale de lecture. */
...
function strokeIcon(children: ReactNode, className?: string) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
