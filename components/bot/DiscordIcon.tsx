 ...
 *
 * Le fichier s'appelait `Icon.tsx` et rendait sept pictogrammes au choix
 * (`relay`, `swords`, `user`, `bell`, `key`, `chart`, `discord`) : six
 * n'habillaient que la grille « Modules », un bloc que rien ne branchait et qui
 * est parti. Ce qui reste ne dessine **qu'une** chose, et le dit dans son nom —
 * un composant nommé `Icon` gardant un paramètre `name` invitait à écrire
 * `<Icon name="bell" />`, qui aurait compilé faux ou rendu un logo Discord.
 */
