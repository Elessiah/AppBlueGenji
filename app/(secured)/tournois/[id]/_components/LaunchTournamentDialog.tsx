...
import { willCloseWithoutMatches } from "@/lib/shared/tournament-launch";
 ...
 * l'effectif** : le dialogue met donc le nombre d'engagés au premier plan, avec
 * l'heure de début qu'on abandonne, plutôt qu'un « êtes-vous sûr ? » qui ne dit
 * rien de ce qui va changer.
 *
 * Le cas du plateau désert est annoncé avant le clic et non découvert après :
 * lancer à moins de deux engagées clôt le tournoi sur-le-champ
    ...
    >
      ...
      >
        ...
        <p style={{ marginTop: 10, fontSize: 13, color: "var(--text-2, #9aa4b2)", lineHeight: 1.55 }}>
          Les inscriptions sont closes immédiatement et le coup d&apos;envoi est avancé à cet
          instant, au lieu du{" "}
