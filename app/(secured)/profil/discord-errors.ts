...
const VERIFICATION_ERRORS: Record<string, string> = {
  ...
  // La recherche n'a pas abouti dans le délai. Deux causes possibles, que le
  // site ne sait pas départager — des serveurs du bot qui tardent à répondre
  // (le tag y est peut-être, ou nulle part), ou un bot surchargé : la phrase
  // nomme les deux plutôt que d'en affirmer une.
  BOT_RESOLVE_TIMEOUT:
